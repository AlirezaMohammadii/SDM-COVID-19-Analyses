...
znormal <- function(name) {
                          ...
                          for(i in 1:length(disease_list)){
                              ...
                              sd <- lapply(disease_list[[i]][7], sd, na.rm = TRUE)
...
test_results = function(norm_val,norm_table) {
                                    ...
                                    pearson_test_plot = data.frame(disease_unique,pearson_test_pop,
                                                                   p_value_pop,kendall_rank_pop,
                                                                   p_value_kenPop,spearman_rank_pop,p_value_spearPop)
...
linear_reg = function(lin_country){
                                   ...
                                   r_sq_P_val = data.frame(coefficient_pop,p_value_pop)
                                   return(r_sq_P_val)
                                   }
